...
/**
 * Precompiled net.onebeastchris.geyserperserverpacks.java-conventions script plugin.
 **/
public class NetOnebeastchrisGeyserperserverpacksJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_NetOnebeastchrisGeyserperserverpacksJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NetOnebeastchrisGeyserperserverpacksJavaConventions").asSubclass(BasicScript.class);
